 ...
 * 
 * \file oanda_stream_api.cpp
 * 
 * TODO:
 */

#pragma once
#include "../include/oanda_stream_api.hpp"
...
namespace Wyeth
{
    OandaStreamApi::OandaStreamApi(const std::string& authToken,
    ...
    const EndpointMap OandaStreamApi::initializeEndpoints() noexcept {
        ...
        {{
            ...
            new Getpoint{"/v3/accounts/{ACCT_ID}/transactions/stream", _parentClt}},
            ...
            {"getPricingStream",
            new Getpoint{"/v3/accounts/{ACCT_ID}/pricing/stream", _parentClt}},
            {"getCandleData",
